import { faPen, faReceipt, faAddressBook, faShirt, faBuilding, faChartColumn, faPowerOff } from '@fortawesome/free-solid-svg-icons';
      ...
      {sideToggle ? (
        <Nav variants={navVariant} initial="init" animate="start" exit="end">
          <List variants={listVariant}>
            <SidebarItem path={SidePaths[0]} name='주문작성' click={sideClick} >
            ...
            <SidebarItem path={SidePaths[5]} name='결제내역' click={sideClick} >
